...
Then you must enable USBMatrix in the Settings menu via the web interface and set the USB port to **/dev/ttyUSB0** (this is the default port for Raspberry). Then restart the server.
